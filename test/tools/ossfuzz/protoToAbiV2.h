 ...
 *	    function coder_public(string memory x_0) public view returns (uint) {
 *	    	if (!bytesCompare(bytes(x_0), "044852b2a670ade5407e78fb2863c51de9fcb96542a07186fe3aeda6bb8a116d"))
 *	    	    return 1;
 *	    	if (!bytesCompare(x_1, "1"))
 *	    	    return 2;
 *		    return 0;
 *	    }
 *
 ...
 *      // a uint value (zero if abi en/decoding was successful, non-zero otherwise)
 *	    function coder_external(string calldata x_0) external view returns (uint) {
 *  		if (!stringCompare(x_0, "044852b2a670ade5407e78fb2863c51de9fcb96542a07186fe3aeda6bb8a116d"))
 *  		    return 1;
 *	    	if (!bytesCompare(x_1, "1"))
 *	    	    return 2;
 *		    return 0;
